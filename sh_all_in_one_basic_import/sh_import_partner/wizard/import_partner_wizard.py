                    ...
                    for row in range(sheet.nrows):
                        try:
                            ...
                            if sheet.cell(row, 1).value != '':
                                ...
                                if isinstance(sheet.cell(row,10).value, float):
                                ...
                                elif self.contact_update_by == 'email' and sheet.cell(row, 11).value not in ['',None]:
                                    partner_domain = [
                                        ('email', '=', sheet.cell(row, 11).value),
                                    ]
                                elif self.contact_update_by == 'phone' and sheet.cell(row, 9).value not in ['',None]:
                                    if isinstance(sheet.cell(row,9).value, float):
                                        phone = int(sheet.cell(row,9).value)
                                        phone_str = str(phone)
                                        partner_domain = [
                                ...
                                elif self.contact_update_by == 'mobile' and sheet.cell(row, 10).value not in ['',None]:
                                    if isinstance(sheet.cell(row,10).value, float):
                                        mobile = int(sheet.cell(row,10).value)
                                        mobile_str = str(mobile)
                                        partner_domain = [
