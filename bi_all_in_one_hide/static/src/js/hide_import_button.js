odoo.define('bi_all_in_one_hide.ImportMenu', function (require) {
    "use strict";
    ...
    var import_group = false;
     var def_import = session.user_has_group('bi_all_in_one_hide.group_import_btn_access').then(function (has_import_group) {
