odoo.define('bi_all_in_one_hide.ActionMenus', function (require) {
	"use strict";
	 var session = require('web.session');

    let print_group
    let action_group
    var def_print = session.user_has_group('bi_all_in_one_hide.group_hide_print_btn').then(function (has_print_group) {
        print_group = has_print_group;
    });
     var def_action = session.user_has_group('bi_all_in_one_hide.group_hide_action_btn').then(function (has_action_group) {
	...
	patch(components.ActionMenus, 'bi_all_in_one_hide.ActionMenus', {
