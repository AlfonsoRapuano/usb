odoo.define("bi_all_in_one_hide.HideCreateExportBtnList", function(require) {
    "use strict";
    ...
    var def_delete = session.user_has_group('bi_all_in_one_hide.group_hide_delete_action').then(function (has_delete_group) {
         delete_group = has_delete_group;
     });
    var def_export_action = session.user_has_group('bi_all_in_one_hide.group_hide_export_action').then(function (has_export_action_group) {
    ...
    ListController.include({
        ...
        willStart: function () {
            var self = this;
            var def_create = session.user_has_group('bi_all_in_one_hide.group_create_btn_access').then(function (has_create_group) {
            ...
            var def_export_btn = session.user_has_group('bi_all_in_one_hide.group_export_btn_access').then(function (has_export_btn_group) {
...
odoo.define("bi_all_in_one_hide.HideCreateEditBtnList", function(require) {
    "use strict";
    ...
    var def_duplicate = session.user_has_group('bi_all_in_one_hide.group_hide_duplicate_action').then(function (has_duplicate_group) {
    ...
    FormController.include({
        ...
        willStart: function () {
            ...
            var def_edit = session.user_has_group('bi_all_in_one_hide.group_edit_form_btn_access').then(function (has_edit_group) {
...
odoo.define("bi_all_in_one_hide.HideCreateImportBtnKanban", function(require) {
    "use strict";
